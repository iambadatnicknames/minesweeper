...
1. **Склонируйте репозиторий**:
   ```bash
   git clone https://github.com/iambadatnicknames/Minesweeper
   ```
...
4. **Запуск игры: Выполните команду для запуска игры**:
   ...
   ```bash
   composer global require iambadatnicknames/minesweeper
   ```
...
## Ссылки на пакеты
- [Packagist пакет Minesweeper](https://packagist.org/packages/iambadatnicknames/minesweeper) 